...
API_URL_DEFAULT = "https://api.blablalink.com/api/game/proxy/Game/GetUnionRaidLevelInfo"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Nikke 工会战 Boss 进度采集（插件内直连接口复刻）")
    parser.add_argument("--url", default=API_URL_DEFAULT, help="接口 URL（默认为 GetUnionRaidLevelInfo）")
